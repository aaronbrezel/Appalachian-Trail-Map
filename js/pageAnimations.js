...
function openwide(){
    ...
    headline.style.padding = "1%";
    
    //animation after beginButton is pressed
    var openWideTimeline = new TimelineMax();
    openWideTimeline.to(map, 3, { width: "33%", right: 0, position: "fixed" })
    .to(firstGraf, 3, { width: "66%", left: "5px", top: "10%", margin: 0, padding: "1%"}, "-=3")
...
function skiptoMain(){
   ...
   .to(firstGraf, 0, { width: "66%", left: "5px", top: "10%", margin: 0, padding: "1%"})
...
function addCopy(){
    ...
    TweenLite.to($("#mainCopy"), 0, { opacity: 1});  
